...
def search(
    ...
    Args:
        ...
        warnings (list of ints, optional): Warnings for the work. 14 for Creator Chose Not To Use Archive Warnings, 16 for No Archive Warnings Apply, 17 for Graphic Depictions Of Violence, 18 for Major Character Death, 19 for Rape/Non-Con, 20 for Underage. Defaults to None.
        ...
        crossover (bool, optional): Whether or not to filter crossovers. None includes crossovers, True includes crossovers and excludes all other fics, and False excludes crossovers. Defaults to None.
    ...
    if crossover is not None:
        query.add_field(f"work_search[crossover]={'T' if completion_status else 'F'}")
    if sort_column != "":
